...
class QuadTreeBin {
  ...
  /*
  Parameters: 
   * maxDepth: The maximum number of permitted subdivisions.
   * maxItemsPerBin: The maximum number of items in a single bin before it is subdivided.
   * extent A `Rect` instance specifying the bounds of this `QuadTreeBin` instance within the QuadTree domain.
   * depth For internal use only.
   */
